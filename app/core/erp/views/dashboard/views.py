...
from core.erp.models import Diario, Endfinanciero, RentaActivo
...
class DashboardView(TemplateView):
    ...
    def get_graph_sales_year_month(self):
        ...
        try:
            ...
            # endfinanciero =
            for m in range(1, 13):
                total = RentaActivo.objects.filter(date_joined__year=year, date_joined__month=m).aggregate(r=Coalesce(Sum('rentaactivo'), 0)).get('r')
